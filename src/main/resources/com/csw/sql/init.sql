...
insert into t_user values ('1','chenyn','123456','admin');
insert into t_user values ('2','xiaohei','123456','student');
--城市表
create table t_city(
	id varchar2(40) primary key,
	name varchar2(40)
...
--insert into t_city values ('3','南京');
--insert into t_city values ('4','深圳');
